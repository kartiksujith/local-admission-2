...
<!--   <header style="position: fixed;right: 1px; top: 80px; width: 100% !important;z-index: 1;">
            ...
            <nav id="menu" style="background-color: #204a84;">
              ...
              <div class="col-md" >
                <div class="abc">
                    <li class="active"><a href="{{ route('me_guardian_details') }}" ><i class="fa fa-fw fa-home"></i>&nbspGuardian Details&nbsp</a></li>
              </div>
              </div>
              <div class="col-md" >
                <div class="abc">
...
<div class="container">
     ...
     <!--  <div class="row-md-8">
        <aside>
          <div class="list-group">
            ...
            <a href="{{ route('me_guardian_details') }}" class="list-group-item active">
  ...
  <div class="col-md-12 col-sm-12">
    ...
    <h1>Guardian Details&nbsp;&nbsp;&nbsp;<label class="btn btn-sm btn-danger" onclick="myFunction()" data-toggle="modal" data-target="#dteGuardian" id="myBtn" style="font-weight: bold; border-radius: 100px">?</label></h1>
      <script>
function myFunction() {
          ...
          <div class="modal-body">
            ...
            <table class="table table-striped table-bordered" id="academic_modal">
              ...
              <tbody>
                ...
                <tr>
                  <td>Annual Income</td>
                  <td>Enter Your family's annual income as mentioned on Income Certificate.</td>
                  <td>9876543210</td>
                </tr>
                <tr>
                  <td>Do You have Parent's Domicile?</td>
                  ...
                  <td>Select <font style="font-weight: bold;">YES</font> if you have parent's domicile. <br> Select <font style="font-weight: bold;">NO</font> if you have domicile application.</td>
                </tr>
              </tbody>
            </table>
          </div>
...
{{--     @if($user1[0]->is_guardian_completed==0) --}}
    ...
    {{-- @endif --}}
    <!---------------------------------Modal Close------------------------------------------>
    <form method="post" action="{{ route('me_guardian_details') }}">
      {{ csrf_field() }}
      @if(session('error'))
          <center>
      ...
      <div class="form-group col-md-6 col-sm-12">
        ...
        <input type="text" onKeyUp="$(this).val($(this).val().replace(/[^\d]/ig, ''))" maxlength="10" class="form-control" id="mobile" name="mobile" oninput="mob()" value="{{$user1[0]->g_mobile}}" placeholder="Mobile No" required>
        <script type="text/javascript">
          function mob() {
      ...
      <div class="form-group col-md-12 col-sm-12">
        ...
        <input type="text" class="form-control" id="office_address" name="office_address" value="{{$user1[0]->g_office_address}}" placeholder="Office Address" required>
        
      </div>
      <div class="form-group col-md-4 col-sm-12">
        <label for="office_tel_no">Office Telephone No<label style="color: red; font-size: 25px;vertical-align: sub;">*</label></label>
        <input type="text" onKeyUp="$(this).val($(this).val().replace(/[^\d]/ig, ''))" class="form-control" id="office_tel_no" name="office_tel_no" value="{{$user1[0]->g_office_tel_no}}" placeholder="Office Telephone No" required>
      ...
      <div class="form-group btnpadding col-md-6 col-sm-12">
        <a  href="{{ route('me_personal_details') }}">
