...
<body>
   <div class="container" >
    ...
    <div class="midcol6 col-md-6">
      ...
      <br>
      <form method="post" action="{{ route('me_change_password') }}">
         {{ csrf_field() }}
         @if(session('error'))
          <center>
            <p> {{session('error')}}</p>
  ...
  <!-- <table class="table table-bordered table-striped">
             <tr>
              ...
              <td >
                 <input type="password" class="form-control" id="password" value="{{-- {{$user1[0]->new_password}} --}}" name="password" minlength="6" placeholder="Enter New Password" >
            <script type="text/javascript">
