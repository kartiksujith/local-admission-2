...
<html>
   ...
   <body>
      <!-------------------------------------------Page 1-------------------------------------------------->
       <div class="container">
         <div class="col-md-12">
           <center><img class="img-responsive" src="{{ asset('images/acap_header_me_admissionForm.jpg') }}"></center>
         </div>
         <!-- <div class="col-md-12">
                        ...
                        <tr>
                           <td id="line" colspan="6">
                              <p align="justify">
                                 ...
                                 Year of Post Graduate Course in Masters Of Engineering for the Academic Year 2018-19. The information given by me in this application is true to the best of my knowledge & belief. If at later stage, it is found that I have furnished wrong information
