                ...
                <!---------------------------View PDF Modal------------------------------->
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <object data="{{ asset('/uploads/'.$user1[0]->dte_id.'_'.$hash.'/'.$user1[0]->gate_result_path) }}" type="application/pdf" width="95%" height="700">
                            <embed src="{{ asset('/uploads/'.$user1[0]->dte_id.'_'.$hash.'/'.$user1[0]->gate_result_path) }}" width="1200px" height="770px" />
                            </embed>
                            </object>
                            </div>
                            <div class="modal-footer">
                 ...
                 <!---------------------------View PDF Modal------------------------------->
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <object data="{{ asset('/uploads/'.$user1[0]->dte_id.'_'.$hash.'/'.$user1[0]->proforma_f_f1_path) }}" type="application/pdf" width="95%" height="700">
                            <embed src="{{ asset('/uploads/'.$user1[0]->dte_id.'_'.$hash.'/'.$user1[0]->proforma_f_f1_path) }}" width="1200px" height="770px" />
                            </embed>
                            </object>
                            </div>
                            <div class="modal-footer">
