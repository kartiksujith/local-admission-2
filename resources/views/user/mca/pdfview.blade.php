...
<html>
   ...
   <body>
      <!-------------------------------------------Page 1-------------------------------------------------->
      <div class="container" style="margin-left: 50px;margin-right: 100px; margin-top: 20px; ">
         <div class="col-md-12">
            <center>
                <img class="img-responsive" src="{{ asset('images/header_mca_admissionForm.jpg') }}">
               ...
               <div class="col-md-12">
                  <table>
                     <thead>
                        <tr>
                           ...
                           <th id="line" colspan="3" style="text-align: right;">Alloted Shift: {{ $users1[0]->shift_allotted }}</th>
                        </tr>
                        <tr>
                        ...
                        <tr>
                           ...
                           <td id="data" colspan="2">&nbsp;{{ $users1[0]->permanent_address_line1 }}</td>
                           <td id="data" colspan="2">&nbsp;{{ $users1[0]->permanent_address_line2 }}</td>
                        </tr>
                        <tr>
                       ...
                       @if( $users1[0]->student_domicile_appl_no != 0 && $users1[0]->student_domicile_no != 0)
                        ...
                        <tr>
                           ...
                           <td id="data" colspan="2">&nbsp;{{ $users1[0]->course_allotted }} - {{ $users1[0]->shift_allotted }}</td>
                        ...
                        <tr>
                           <td id="line" colspan="12">
                              <p align="justify">
                                 ...
                                 Year of Post Graduate Course in Masters Of Computer Application for the Academic Year 2019-20. The information given by me in this application is true to the best of my knowledge & belief. If at later stage, it is found that I have furnished wrong information
                  ...
                  <table>
                     <thead>
                        ...
                        <tr>
                           <td id="line" colspan="6">
                              <p>I Mr./Miss. <b>{{ $users1[0]->name_on_marksheet }}</b> hereby declare that I am taking admission to the Masters of Engineering for the Academic Year: <b>2019-20</b> in V.E.S Institute of Technology, Chembur-74.</p>
                              <p>I am not submitting the following Original Documents at the time of the above said Admission:</p>
                           </td>
                        </tr>
                        @if( $users1[0]->photo == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display:inline; " src="{{ asset('images/glyphicon-remove.png') }}">&nbsp;Profile Photo</td>
                        </tr>
                        @endif
                        @if( $users1[0]->signature == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display:inline; " src="{{ asset('images/glyphicon-remove.png') }}">&nbsp;Signature</td>
                        </tr>
                        @endif
                        @if( $users1[0]->fc_confirmation_receipt == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display:inline; " src="{{ asset('images/glyphicon-remove.png') }}">&nbsp;FC Confirmation Receipt</td>
                        </tr>
                        @endif
                        @if( $users1[0]->dte_allotment_letter == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display:inline; " src="{{ asset('images/glyphicon-remove.png') }}">&nbsp;DTE Allotment Letter</td>
                        </tr>
                        @endif
                        @if( $users1[0]->arc_ackw_receipt == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('images/glyphicon-remove.png') }}">&nbsp;ARC Acknowledgement</td>
                        </tr>
                        @endif
                        @if( $users1[0]->cet_result == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('images/glyphicon-remove.png') }}">&nbsp;CET Result</td>
                        </tr>
                        @endif
                        @if( $users1[0]->ssc_marksheet == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('images/glyphicon-remove.png') }}">&nbsp;SSC Marksheet</td>
                        </tr>
                        @endif
                        @if( $users1[0]->hsc_diploma_marksheet == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('images/glyphicon-remove.png') }}">&nbsp;HSC / Diploma Marksheet</td>
                        </tr>
                        @endif
                        @if( $users1[0]->degree_leaving_tc == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('images/glyphicon-remove.png') }}">&nbsp;Degree Leaving/Transfer Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->first_year_marksheet == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('images/glyphicon-remove.png') }}">&nbsp;First Year Marksheet</td>
                        </tr>
                        @endif
                        @if( $users1[0]->second_year_marksheet == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display:inline; " src="{{ asset('images/glyphicon-remove.png') }}">&nbsp;Second Year Marksheet</td>
                        </tr>
                        @endif
                        @if( $users1[0]->third_year_marksheet == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display:inline; " src="{{ asset('images/glyphicon-remove.png') }}">&nbsp;Third Year Marksheet</td>
                        </tr>
                        @endif
                        @if( $users1[0]->convocation_passing_certi == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display:inline; " src="{{ asset('images/glyphicon-remove.png') }}">&nbsp;Convocation/Passing Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->migration_certi == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('images/glyphicon-remove.png') }}">&nbsp;Migration Certificate</td>
                        </tr>
                        @endif
                        @if($users1[0]->domicile == 'Yes')
                            @if( $users1[0]->birth_certi == 'No')
                            <tr>
                               <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('images/glyphicon-remove.png') }}">&nbsp;Birth Certificate</td>
                            </tr>
                            @endif
                        @endif
                        @if($users1[0]->birth_certi == 'Yes')
                            ...
                            <tr>
                               <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('images/glyphicon-remove.png') }}">&nbsp;Domicile Certificate</td>
                            </tr>
                            @endif
                        @endif
                        @if( $users1[0]->proforma_o == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display:inline; " src="{{ asset('images/glyphicon-remove.png') }}">&nbsp;Proforma O</td>
                        </tr>
                        @endif
                        @if( $users1[0]->retention == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('images/glyphicon-remove.png') }}">&nbsp;Retention Certificate</td>
                        </tr>
                        @endif
                        ...
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('images/glyphicon-remove.png') }}">&nbsp;Gap Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->community_certi == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display:inline; " src="{{ asset('images/glyphicon-remove.png') }}">&nbsp;Community Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->caste_certi == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display:inline; " src="{{ asset('images/glyphicon-remove.png') }}">&nbsp;Caste Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->caste_validity_certi == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display:inline; " src="{{ asset('images/glyphicon-remove.png') }}">&nbsp;Caste Validity Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->non_creamy_layer_certi == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display:inline; " src="{{ asset('images/glyphicon-remove.png') }}">&nbsp;Non-Creamy Layer Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->proforma_a_b1_b2 == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display:inline; " src="{{ asset('images/glyphicon-remove.png') }}">&nbsp;Proforma A B1 B2</td>
                        </tr>
                        @endif
                        @if( $users1[0]->income_certi == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('images/glyphicon-remove.png') }}">&nbsp;Income Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->proforma_c_d_e == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display:inline; " src="{{ asset('images/glyphicon-remove.png') }}">&nbsp;Proforma C D E</td>
                        </tr>
                        @endif
                        @if( $users1[0]->medical_certi == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('images/glyphicon-remove.png') }}">&nbsp;Physical Fitness Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->anti_ragging_affidavit == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('images/glyphicon-remove.png') }}">&nbsp;Anti Ragging Certificate</td>
                        </tr>
                        @endif
                        <tr>
                           <td id="line" colspan="6">
                  ...
                  <table>
                     <thead>
                        ...
                        <tr>
                           <td id="line" colspan="6">
                              <p align="justify">
                                 I Mr./Miss. <b>{{ $users1[0]->name_on_marksheet }}</b> hereby declare that I am taking admission to the Masters of Engineering.
                                 for the Academic Year: 2019-20 in V.E.S Institute of Technology,
                                 Chembur-74.
                              </p>
                        ...
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('images/glyphicon-ok.jpg') }}">&nbsp;FC Confirmation Receipt</td>
                        </tr>
                        @endif
                        @if( $users1[0]->dte_allotment_letter == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display:inline; " src="{{ asset('images/glyphicon-ok.jpg') }}">&nbsp;DTE Allotment Letter</td>
                        </tr>
                        @endif
                        @if( $users1[0]->arc_ackw_receipt == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('images/glyphicon-ok.jpg') }}">&nbsp;ARC Acknowledgement</td>
                        </tr>
                        @endif
                        @if( $users1[0]->cet_result == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('images/glyphicon-ok.jpg') }}">&nbsp;CET Result</td>
                        </tr>
                        @endif
                        @if( $users1[0]->ssc_marksheet == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('images/glyphicon-ok.jpg') }}">&nbsp;SSC Marksheet</td>
                        </tr>
                        @endif
                        @if( $users1[0]->hsc_diploma_marksheet == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('images/glyphicon-ok.jpg') }}">&nbsp;HSC / Diploma Marksheet</td>
                        </tr>
                        @endif
                        @if( $users1[0]->degree_leaving_tc == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display:inline; " src="{{ asset('images/glyphicon-ok.jpg') }}">&nbsp;Degree Leaving/Transfer Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->first_year_marksheet == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('images/glyphicon-ok.jpg') }}">&nbsp;First Year Marksheet</td>
                        </tr>
                        @endif
                        @if( $users1[0]->second_year_marksheet == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display:inline; " src="{{ asset('images/glyphicon-ok.jpg') }}">&nbsp;Second Year Marksheet</td>
                        </tr>
                        @endif
                        @if( $users1[0]->third_year_marksheet == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('images/glyphicon-ok.jpg') }}">&nbsp;Third Year Marksheet</td>
                        </tr>
                        @endif
                        @if( $users1[0]->convocation_passing_certi == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display:inline; " src="{{ asset('images/glyphicon-ok.jpg') }}">&nbsp;Convocation/Passing Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->migration_certi == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('images/glyphicon-ok.jpg') }}">&nbsp;Migration Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->birth_certi == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('images/glyphicon-ok.jpg') }}">&nbsp;Birth Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->domicile == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display:inline; " src="{{ asset('images/glyphicon-ok.jpg') }}">&nbsp;Domicile Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->proforma_o == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('images/glyphicon-ok.jpg') }}">&nbsp;Proforma O</td>
                        </tr>
                        @endif
                        @if( $users1[0]->retention == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('images/glyphicon-ok.jpg') }}">&nbsp;Retention Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->minority_affidavit == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('images/glyphicon-ok.jpg') }}">&nbsp;Minority Affidavit</td>
                        </tr>
                        @endif
                        @if( $users1[0]->gap_certi == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('images/glyphicon-ok.jpg') }}">&nbsp;Gap Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->community_certi == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('images/glyphicon-ok.jpg') }}">&nbsp;Community Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->caste_certi == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('images/glyphicon-ok.jpg') }}">&nbsp;Caste Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->caste_validity_certi == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('images/glyphicon-ok.jpg') }}">&nbsp;Caste Validity Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->non_creamy_layer_certi == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('images/glyphicon-ok.jpg') }}">&nbsp;Non-Creamy Layer Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->proforma_a_b1_b2 == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('images/glyphicon-ok.jpg') }}">&nbsp;Proforma A B1 B2</td>
                        </tr>
                        @endif
                        @if( $users1[0]->income_certi == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display:inline; " src="{{ asset('images/glyphicon-ok.jpg') }}">&nbsp;Income Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->proforma_c_d_e == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display:inline; " src="{{ asset('images/glyphicon-ok.jpg') }}">&nbsp;Proforma C D E</td>
                        </tr>
                        @endif
                        @if( $users1[0]->medical_certi == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display:inline; " src="{{ asset('images/glyphicon-ok.jpg') }}">&nbsp;Physical Fitness Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->anti_ragging_affidavit == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('images/glyphicon-ok.jpg') }}">&nbsp;Anti Ragging Certificate</td>
                        </tr>
                        @endif
                        <tr>
                           <td id="line" colspan="6">
                        ...
                        <tr>
                           <td id="line" colspan="6">
                              <p align="justify">
                                 ...
                                 Academic Year: 2019-20 in the branch of Masters of Computer Applications <b>{{ $users1[0]->shift_allotted }} Shift</b>.
                              </p>
                  ...
                  <!--  <table class="footerposition" cellspacing="10">
                   ...
                   <tr style= "height:200px;">
                      <td style="border-radius:15px;border:2px solid black;padding: 5px; width: 340px;">
                ...
                <div style="float:left;">
                    ...
                    <p style=" margin-top:-5px;"><b style="font-size:12px;">&nbsp;&nbsp;&nbsp;&nbsp;NAME:</b> {{ $users1['last_name'] }} {{ $users1['first_name'] }} {{$users1['middle_name']}}</p>
                    ...
                    <p style=" margin-top:5px;"><b style="font-size:12px;">&nbsp;&nbsp;&nbsp;&nbsp;Course:{{ $users1[0]->course_allotted }}</b></p>
