...
<body>
         ...
         <!-- <div class="row-md-8">
            <aside>
               <div class="list-group">
                  <a href="{{ route('dse_profile') }}" class="list-group-item">
                     <h5 class="list-group-item-heading">Account Details</h5>
                  </a>
                  <a href="{{ route('dse_payment_details') }}" class="list-group-item active">
                     <h5 class="list-group-item-heading">Payment Details</h5>
                  </a>
                  <a href="{{ route('dse_change_password') }}" class="list-group-item">
   ...
   <div class="col-md-12">
      ...
      <br>
      <form method="get" action="{{ route('dse_payment_details') }}">
