...
<div class="container">
  <br>
   ...
   <div class="col-md-12">
            ...
            <CENTER><b><font color="red">NOTE :UPLOAD ONLY PDF FILES LESS THAN 2 MB. </font> </b></CENTER>
            </div>

        <form method="post" action="{{route('user_payment_show_cash')}}" enctype="multipart/form-data">
            
            <div class="form-group col-md-6 col-sm-12">
                <label for="amount">Course Amount<label style="color: red; font-size: 25px;vertical-align: sub;">*</label></label>
                @if($balance_amt)
              <input type="text" class="form-control" id="amount" name="amount" value="{{$balance_amt}}"   style="color: black" >
              @elseif($fees)
              <input type="text" class="form-control" id="amount" name="amount" value="{{$fees}}"   style="color: black" >
              @elseif($part)
              <input type="text" class="form-control" id="amount" name="amount" value="{{$part}}"   style="color: black" >
              @endif
            ...
            <div class="form-group col-md-6 col-sm-12 ">
                <label for="reciptno">Recipt Number<label style="color: red; font-size: 25px;vertical-align: sub;">*</label></label>
                <input type="text" class="form-control" id="reciptno" name="reciptno" placeholder="Enter recipt number">            
            </div>
            <div class="form-group col-md-6 col-sm-12 ">
          ...
          function mob() {
            ...
            <div class="form-group col-md-6 col-sm-12 ">
                <label for="recipt_date">Recipt Date<label style="color: red; font-size: 25px;vertical-align: sub;">*</label></label>
                <input type="date" class="form-control" id="recipt_date" name="recipt_date" value=""  placeholder="Select DD Date" required>
            </div>
            <div class="form-group col-md-6 col-sm-12 ">
                <label for="dd_no">Recipt Image<label style="color: red; font-size: 25px;vertical-align: sub;">*</label></label>
                <input type="file"  id="dd_no" name="reciptimg"  accept=".pdf" required>
            </div>
