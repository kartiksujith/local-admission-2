               ...
               <div class="col-md-12">
                  ...
                  <table>
                     <thead>
                        ...
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display: inline;" max-width="100%"  src="{{ asset('images/glyphicon-remove.png') }}">&nbsp;&nbsp;&nbsp;Profile Photo</td>
                        </tr>
                        @endif
                        @if( $users1[0]->signature == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display: inline;" max-width="100%"  src="{{ asset('images/glyphicon-remove.png') }}">&nbsp;&nbsp;&nbsp;Signature</td>
                        </tr>
                        @endif
                        @if( $users1[0]->fc_confirmation_receipt == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style=" display:inline; height:10px;" max-width="100%"  src="{{ asset('images/glyphicon-remove.png') }}">&nbsp;&nbsp;&nbsp;FC Confirmation Receipt</td>
                        </tr>
                        @endif
                        @if( $users1[0]->dte_allotment_letter == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display: inline;" max-width="100%"  src="{{ asset('images/glyphicon-remove.png') }}">&nbsp;&nbsp;&nbsp;DTE Allotment Letter</td>
                        </tr>
                        @endif
                        @if( $users1[0]->arc_ackw_receipt == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display:inline; " max-width="100%"  src="{{ asset('images/glyphicon-remove.png') }}">&nbsp;&nbsp;&nbsp;ARC Acknowledgement</td>
                        </tr>
                        @endif
                        @if( $users1[0]->cet_result == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"  style="height:10px; display:inline; " max-width="100%" src="{{ asset('images/glyphicon-remove.png') }}">&nbsp;&nbsp;&nbsp;CET Result</td>
                        </tr>
                        @endif
                        @if( $users1[0]->ssc_marksheet == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display:inline; " max-width="100%"  src="{{ asset('images/glyphicon-remove.png') }}">&nbsp;&nbsp;&nbsp;SSC Marksheet</td>
                        </tr>
                        @endif
                        @if( $users1[0]->hsc_passing_certi == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display:inline; " max-width="100%"  src="{{ asset('images/glyphicon-remove.png') }}">&nbsp;&nbsp;&nbsp;Convocation/Passing Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->migration_certi == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display:inline; " max-width="100%"  src="{{ asset('images/glyphicon-remove.png') }}">&nbsp;&nbsp;&nbsp;Migration Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->birth_certi == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display:inline; " max-width="100%"  src="{{ asset('images/glyphicon-remove.png') }}">&nbsp;&nbsp;&nbsp;Birth Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->domicile == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display:inline; " max-width="100%"  src="{{ asset('images/glyphicon-remove.png') }}">&nbsp;&nbsp;&nbsp;Domicile Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->proforma_o == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display:inline; " max-width="100%"  src="{{ asset('images/glyphicon-remove.png') }}">&nbsp;&nbsp;&nbsp;Proforma O</td>
                        </tr>
                        @endif
                        @if( $users1[0]->retention == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display:inline; " max-width="100%"  src="{{ asset('images/glyphicon-remove.png') }}">&nbsp;&nbsp;&nbsp;Retention Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->minority_affidavit == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display:inline; " max-width="100%"  src="{{ asset('images/glyphicon-remove.png') }}">&nbsp;&nbsp;&nbsp;Minority Affidavit</td>
                        </tr>
                        @endif
                        @if( $users1[0]->gap_certi == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display:inline; " max-width="100%"  src="{{ asset('images/glyphicon-remove.png') }}">&nbsp;&nbsp;&nbsp;Gap Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->community_certi == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display:inline; " max-width="100%"  src="{{ asset('images/glyphicon-remove.png') }}">&nbsp;&nbsp;&nbsp;Community Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->caste_certi == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display:inline; " max-width="100%"  src="{{ asset('images/glyphicon-remove.png') }}">&nbsp;&nbsp;&nbsp;Caste Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->caste_validity_certi == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"  style="height:10px; display:inline; " max-width="100%" src="{{ asset('images/glyphicon-remove.png') }}">&nbsp;&nbsp;&nbsp;Caste Validity Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->non_creamy_layer_certi == 'No')
                        <tr> style="height:10px; display:inline; " max-width="100%" 
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display:inline; " max-width="100%"  src="{{ asset('images/glyphicon-remove.png') }}">&nbsp;&nbsp;&nbsp;Non-Creamy Layer Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->proforma_a_b1_b2 == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display:inline; " max-width="100%"  src="{{ asset('images/glyphicon-remove.png') }}">&nbsp;&nbsp;&nbsp;Proforma A B1 B2</td>
                        </tr>
                        @endif
                        @if( $users1[0]->income_certi == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"  style="height:10px; display:inline; " max-width="100%" src="{{ asset('images/glyphicon-remove.png') }}">&nbsp;&nbsp;&nbsp;Income Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->proforma_c_d_e == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"  style="height:10px; display:inline; " max-width="100%" src="{{ asset('images/glyphicon-remove.png') }}">&nbsp;&nbsp;&nbsp;Proforma C D E</td>
                        </tr>
                        @endif
                        @if( $users1[0]->proforma_j_k_l == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"  style="height:10px; display:inline; " max-width="100%" src="{{ asset('images/glyphicon-remove.png') }}">&nbsp;&nbsp;&nbsp;Proforma J K L</td>
                        </tr>
                        @endif
                        @if( $users1[0]->medical_certi == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"  style="height:10px; display:inline; " max-width="100%" src="{{ asset('images/glyphicon-remove.png') }}">&nbsp;&nbsp;&nbsp;Physical Fitness Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->anti_ragging_affidavit == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"  style="height:10px; display:inline; " max-width="100%" src="{{ asset('images/glyphicon-remove.png') }}">&nbsp;&nbsp;&nbsp;Anti Ragging Certificate</td>
                        </tr>
                        @endif
                        <tr>
                           <td id="line" colspan="6">
