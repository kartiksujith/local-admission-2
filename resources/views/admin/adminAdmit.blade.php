        ...
        <form method="post" action="{{ route('adminAdmit') }}">
          ...
          <div class="form-group">
                  ...
                  <tr>
                    ...
                    @elseif($course == "MCA")
                     ...
                     @elseif($course == "FEG" || $course == "DSE")
                        ...
                        <td>
                          <select id="branch" name="branch">
                            <option value="CMPN1" >CMPN-I</option>
                            <option value="CMPN2" >CMPN-II</option>
                            <option value="IT" >IT</option>
            ...
            <div class="form-group col-md-12 input-group">
              ...
              <input type="text" class="form-control" id="amount" name="amount" value="{{$users[0]->balance_amt}}"  style="color: black" readonly>
              @elseif($fees[0]->amt)
