...
<div id='main-menu' class='main-menu'>
  <div class='container-menu' style="margin-bottom: -13px;">
    ...
    <li id="<?php echo md5('fe_dte_details'); ?>" ><a class="isDisabled "  style="text-decoration: none !important;"  href="{{ route('fe_dte_details') }} " ><i class="fa fa-fw fa-home";></i>&nbspDTE Details&nbsp</a></li>
    
<li  id="<?php echo md5('fe_academic_details'); ?>" ><a class="isDisabled "  style="text-decoration: none !important;"  href="{{ route('fe_academic_details') }}" ><i class="fa fa-fw fa-home";></i>&nbspAcademic Details&nbsp</a></li>

 <li id="<?php echo md5('fe_personal_details'); ?>" ><a  class="isDisabled " style="text-decoration: none !important;"  href="{{ route('fe_personal_details') }}" ><i class="fa fa-fw fa-home";></i>&nbspPersonal Details&nbsp</a></li>
 
<li  id="<?php echo md5('fe_guardian_details'); ?>" ><a class="isDisabled "  style="text-decoration: none !important;"  href="{{ route('fe_guardian_details') }}" ><i class="fa fa-fw fa-home"></i>&nbspGuardian Details&nbsp</a></li>


<li id="<?php echo md5('fe_contact_details'); ?>" ><a  class="isDisabled " style="text-decoration: none !important;"  href="{{ route('fe_contact_details') }}" ><i class="fa fa-phone"></i>Contact Details&nbsp</a></li>
   @if(session('log_acap') == "yes")
<li id="<?php echo md5('fe_acap_document_upload'); ?>" ><a class="isDisabled"  style="text-decoration: none !important;"  href="{{ route('fe_acap_document_upload') }}"><i class="fa fa-fw fa-database"></i>&nbsp&nbspDocument Upload&nbsp&nbsp&nbsp</a></li>
<li id="<?php echo md5('fe_acap_form_payment'); ?>" ><a  style="text-decoration: none !important;"  href="{{ route('fe_acap_form_payment') }}"><i class="fa fa-fw fa-database"></i>&nbsp&nbspPayment&nbsp</a></li>
              @endif
...
<li><a style="text-decoration: none !important;"  href="{{ route('logout') }} " ><i class="fa fa-fw fa-power-off"></i>&nbsp&nbsp &nbspLogout</a></li>
   ...
   @if(session('log_course')=='MEG')
    ...
    <li id="<?php echo md5('me_dte_details'); ?>" ><a class="isDisabled"  style="text-decoration: none !important;"  href="{{ route('me_dte_details') }} " ><i class="fa fa-fw fa-home";></i>&nbspDTE Details&nbsp</a></li>
    
<li  id="<?php echo md5('me_academic_details'); ?>" ><a class="isDisabled"  style="text-decoration: none !important;"  href="{{ route('me_academic_details') }}" ><i class="fa fa-fw fa-home";></i>&nbspAcademic Details&nbsp</a></li>

 <li id="<?php echo md5('me_personal_details'); ?>" ><a  class="isDisabled" style="text-decoration: none !important;"  href="{{ route('me_personal_details') }}" ><i class="fa fa-fw fa-home";></i>&nbspPersonal Details&nbsp</a></li>
 
<li  id="<?php echo md5('me_guardian_details'); ?>" ><a  class="isDisabled" style="text-decoration: none !important;"  href="{{ route('me_guardian_details') }}" ><i class="fa fa-fw fa-home"></i>&nbspGuardian Details&nbsp</a></li>


<li id="<?php echo md5('me_contact_details'); ?>" ><a class="isDisabled"  style="text-decoration: none !important;"  href="{{ route('me_contact_details') }}" ><i class="fa fa-phone"></i>Contact Details&nbsp</a></li>
   @if(session('log_acap') == "yes")
<li id="<?php echo md5('me_acap_document_upload'); ?>" ><a  class="isDisabled"  style="text-decoration: none !important;"  href="{{ route('me_acap_document_upload') }}"><i class="fa fa-fw fa-database"></i>&nbsp&nbspDocument Upload&nbsp&nbsp&nbsp</a></li>
            
            <li id="<?php echo md5('me_acap_form_payment'); ?>" ><a style="text-decoration: none !important;"  href="{{ route('me_acap_form_payment') }}"><i class="fa fa-fw fa-database"></i>&nbsp&nbspPayment&nbsp</a></li>
              @endif
...
<li><a style="text-decoration: none !important;"  href="{{ route('logout') }} " ><i class="fa fa-fw fa-power-off"></i>&nbsp&nbsp &nbspLogout</a></li>
    ...
    <li id="<?php echo md5('dse_dte_details'); ?>" ><a class="isDisabled"  style="text-decoration: none !important;"  href="{{ route('dse_dte_details') }} " ><i class="fa fa-fw fa-home";></i>&nbspDTE Details&nbsp</a></li>
    
<li  id="<?php echo md5('dse_academic_details'); ?>" ><a  class="isDisabled" style="text-decoration: none !important;"  href="{{ route('dse_academic_details') }}" ><i class="fa fa-fw fa-home";></i>&nbspAcademic Details&nbsp</a></li>

 <li id="<?php echo md5('dse_personal_details'); ?>" ><a  class="isDisabled" style="text-decoration: none !important;"  href="{{ route('dse_personal_details') }}" ><i class="fa fa-fw fa-home";></i>&nbspPersonal Details&nbsp</a></li>
 
<li  id="<?php echo md5('dse_guardian_details'); ?>" ><a  class="isDisabled" style="text-decoration: none !important;"  href="{{ route('dse_guardian_details') }}" ><i class="fa fa-fw fa-home"></i>&nbspGuardian Details&nbsp</a></li>


<li id="<?php echo md5('dse_contact_details'); ?>" ><a  class="isDisabled" style="text-decoration: none !important;"  href="{{ route('dse_contact_details') }}" ><i class="fa fa-phone"></i>Contact Details&nbsp</a></li>
   @if(session('log_acap') == "yes")
<li id="<?php echo md5('dse_acap_document_upload'); ?>" ><a  class="isDisabled" style="text-decoration: none !important;"  href="{{ route('dse_acap_document_upload') }}"><i class="fa fa-fw fa-database"></i>&nbsp&nbspDocument Upload&nbsp&nbsp&nbsp</a></li>

<li id="<?php echo md5('dse_acap_form_payment'); ?>" ><a style="text-decoration: none !important;"  href="{{ route('dse_acap_form_payment') }}"><i class="fa fa-fw fa-database"></i>&nbsp&nbspPayment&nbsp</a></li>
              @endif
...
<li><a style="text-decoration: none !important;"  href="{{ route('logout') }} " ><i class="fa fa-fw fa-power-off"></i>&nbsp&nbsp &nbspLogout</a></li>
    ...
    <li id="<?php echo md5('mca_dte_details'); ?>" ><a class="isDisabled" style="text-decoration: none !important;"  href="{{ route('mca_dte_details') }} " ><i class="fa fa-fw fa-home";></i>&nbspDTE Details&nbsp</a></li>
    
<li  id="<?php echo md5('mca_academic_details'); ?>" ><a class="isDisabled" style="text-decoration: none !important;"  href="{{ route('mca_academic_details') }}" ><i class="fa fa-fw fa-home";></i>&nbspAcademic Details&nbsp</a></li>

 <li id="<?php echo md5('mca_personal_details'); ?>" ><a class="isDisabled" style="text-decoration: none !important;"  href="{{ route('mca_personal_details') }}" ><i class="fa fa-fw fa-home";></i>&nbspPersonal Details&nbsp</a></li>
 
<li  id="<?php echo md5('mca_guardian_details'); ?>" ><a class="isDisabled" style="text-decoration: none !important;"  href="{{ route('mca_guardian_details') }}" ><i class="fa fa-fw fa-home"></i>&nbspGuardian Details&nbsp</a></li>


<li id="<?php echo md5('mca_contact_details'); ?>" ><a class="isDisabled"style="text-decoration: none !important;"  href="{{ route('mca_contact_details') }}" ><i class="fa fa-phone"></i>Contact Details&nbsp</a></li>
   @if(session('log_acap') == "yes")
<li id="<?php echo md5('mca_document_upload'); ?>" ><a class="isDisabled" style="text-decoration: none !important;"  href="{{ route('mca_document_upload') }}"><i class="fa fa-fw fa-database"></i>&nbsp&nbspDocument Upload&nbsp&nbsp&nbsp</a></li>

<li id="<?php echo md5('mca_acap_form_payment'); ?>" ><a style="text-decoration: none !important;"  href="{{ route('mca_acap_form_payment') }}"><i class="fa fa-fw fa-database"></i>&nbsp&nbspPayment&nbsp</a></li>
              @endif
