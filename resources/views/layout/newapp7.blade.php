    ...
    <nav class='navigation'>
      ...
      <ul class='core-menu '>
        ...
        <li><a href='#'><i  class="fa">&#xf0c0;</i>&nbsp;Students Intake<span class='toggle'></span></a>
          <ul class='dropdown'>
            <li><a href="https://vesitadmissions.ves.ac.in/doc/12">FE</a></li>
            <li><a href="https://vesitadmissions.ves.ac.in/doc/22">DSE</a></li>
            <li><a href="https://vesitadmissions.ves.ac.in/doc/32">MCA</a></li>
            <li><a href="https://vesitadmissions.ves.ac.in/doc/42">ME</a></li>
          </ul>
        </li>
    <li class="lispace" ><a href='#'><i class='fas'>&#xf156;</i>Fee Structure<span class='toggle'></span></a>
          
             <ul class='dropdown'>
            <li><a href="https://vesitadmissions.ves.ac.in/doc/11">FE</a></li>
            <li><a href="https://vesitadmissions.ves.ac.in/doc/21">DSE</a></li>
            <li><a href="https://vesitadmissions.ves.ac.in/doc/31">MCA</a></li>
            <li><a href="https://vesitadmissions.ves.ac.in/doc/41">ME</a></li>
          </ul>
          
        </li>
        <li class="lispace" ><a href='#'><i class="fa">&#xf19d;</i>Under Graduate <span class='toggle'></span></a>
          <ul class='dropdown'>
            <li><a href='#'>FE<span class='toggle2'></span></a></a>
              <ul class='dropdown2'>
                <li><a href="">List of required document</a></li>
                <li><a href="">DTE CAP Manual</a></li>
                <li><a href="">Merit List</a></li>
              </ul>
            </li>
            <li><a href='#'>DSE<span class='toggle2'></span></a></a>
              <ul class='dropdown2'>
                <li><a href="">List of required document</a></li>
                <li><a href="">DTE CAP Manual</a></li>
                <li><a href="">Merit List</a></li>
          ...
          <ul class='dropdown'>
            <li><a href='#'>MCA<span class='toggle2'></span></a></a>
              <ul class='dropdown2'>
                <li><a href="">List of required document</a></li>
                <li><a href="">DTE CAP Manual</a></li>
                <li><a href="">Merit List</a></li>
            ...
            <li><a href='#'>ME<span class='toggle2'></span></a></a>
              <ul class='dropdown2'>
                <li><a href="">List of required document</a></li>
                <li><a href="">DTE CAP Manual</a></li>
                <li><a href="">Merit List</a></li>
        ...
        <li class="lispace" ><a href='#'><i class="fa fa-fw fa-user"></i>Login/Register <span class='toggle'></span></a>
             ...
             <ul class='dropdown'>
            <li><a href="{{ asset('acapInstruction') }}">ACAP Vacancy Form</a></li>
