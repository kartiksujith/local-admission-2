      ...
      <div class="container-fluid top-banner">
         <div class="container">
            <div class="col-md-12 pull-left top-banner-contact">
               ...
               <a href="mailto:vesit.admission@ves.ac.in"><span class="fa fa-envelope" aria-hidden="true"></span> &nbsp;vesit.admission@ves.ac.in</a>
            </div>
         </div>
      </div>
   </header>
                 ...
                 <div class="container-fluid">
                   <ul class="nav navbar-nav navbar-right">
                    @if(session('log_course')=='FEG')
                     <li><a href="{{ route('fe_profile') }}"><span class="glyphicon glyphicon-user"></span> Profile</a></li>
                     @elseif(session('log_course')=='MCA')
                     <li><a href="{{ route('mca_profile') }}"><span class="glyphicon glyphicon-user"></span> Profile</a></li>
                     @elseif(session('log_course')=='MEG')
                     <li><a href="{{ route('me_profile') }}"><span class="glyphicon glyphicon-user"></span> Profile</a></li>
                     @elseif(session('log_course')=='DSE')
                     <li><a href="{{ route('dse_profile') }}"><span class="glyphicon glyphicon-user"></span> Profile</a></li>
                     @endif
